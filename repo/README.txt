...
Freemind Repository component for Alfresco Repository
=============================================================

Author: Rasmus Melgaard

This project defines a Freemind Repo component for SAlfresco Repository,
that enables the execution of Freemind webscripts in the repository. 
...
you'll find two jar files within that folder. The Freemind-repo.jar needs
to be copied into the Alfresco repository:

  tomcat/webapps/alfresco/WEB-INF/lib/
  
The other file Freemind-share.jar needs to be copied to the 
corresponding folder in the Share webapp:

  tomcat/webapps/share/WEB-INF/lib/
  
The deployment location has changed recently (with Freemind Repo)
because the Freemind Repo now uses Java classes that have to be deployed 
...
The command should build a JAR file named Freemind-repo.jar or
Freemind-share.jar in the 'dist' directory within your project.

There also is the Freemind-dist which builds both jar files and 
...
page. Click 'Freemind Repo' in the left hand side navigation.
